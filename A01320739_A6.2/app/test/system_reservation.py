...
The delete_hotel method deletes the JSON file of the
hotel if it exists.
The display_hotel_info method reads and displays hotel information
from the JSON file.
...
The cancel_reservation method removes a reservation
from the JSON file of the hotel.
"""
...
#hotel = Hotel("HotelXYZ")
#hotel.create_hotel()
#hotel.display_hotel_info()

#hotel.modify_hotel_info("Marriot Bonvoy")
#hotel.display_hotel_info()
